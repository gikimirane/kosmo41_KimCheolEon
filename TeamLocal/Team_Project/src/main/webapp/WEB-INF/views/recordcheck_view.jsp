		...
		<section class="event_summary">
			...
			<div class="left_area">
				...
				<div class="event_thumbnail main_thumbnail">
					<img src="resources/image/${recordcheck_view.upLoad}" name="filename">
				</div>
			</div>

			<div class="right_area">
				<h3 class="event_title">${recordcheck_view.eMali} 님의 활동기록</h3>
				<ul class="event_info_wrap">
					...
					<li>
						...
						<p class="description place">
							<span class="adress">${recordcheck_view.moveTime}</span> <a type="button"
								href="#eventMap">활동 지도보기</a>
						</p>
					</li>
				</ul>
