...
var startApp = function() {
  gapi.load('auth2', function(){
    ...
    auth2 = gapi.auth2.init({
      client_id: '659512930101-dafr3f3clivqftkb7ql32dhqgh8p9apt.apps.googleusercontent.com',
...
function submitAjax(){
	$.ajax({
		url : 'joinOK',
		type : 'POST',
		data : 'name=' + document.reg_frm.name.value + "&eMail=" + document.reg_frm.eMail.value + 
			"&phone=" + document.reg_frm.phone.value + "&pw=" + document.reg_frm.pw.value,
