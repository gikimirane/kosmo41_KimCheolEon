		...
		<div class="container">
			<table class="table table-striped" width="800">
				<div>
					...
					<tr>
						<td>제목</td>
						<td><input type="text" name="bTitle" value="[re] : " size="50"></td>
					</tr>
					<tr>
						<td>내용</td>
						<td><textarea name="bContent" id="editor1" rows="10" cols="80"></textarea> 
								<script>
					...
					<tr>
						...
						<td colspan="2" align="right"><input type="submit" value="답변">
