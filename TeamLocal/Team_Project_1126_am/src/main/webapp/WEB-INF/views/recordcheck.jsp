<%@page import="com.study.spring.signup.dto.RecordDto"%>
  ...
  var chartDrowFun = {
    ...
    chartDrow : function(){
        ...
        function drawDashboard() {
      	...
      	ArrayList<RecordDto> rDto = (ArrayList<RecordDto>)session.getAttribute("setting");
      	for(int j=0;j<rDto.size();j++) {
      		...
      		/* System.out.println("년 : " + yy[0]);
      		System.out.println("월 : " + Integer.toString(Integer.parseInt(yy[1])-1));
      		System.out.println("일 : " + dd[0]); */
      	     ...
      	     int value = (Integer.parseInt(mm)*60) + Integer.parseInt(ss);
      	   	 ...
      	   	 /* System.out.println("ss : " + ss); 				// 시간(초) 
      	     System.out.println("ssConvert : " + ssConvert);	// 시간(초)
      	   	 System.out.println("mm : " + mm);					// 시간(분)
    	     System.out.println("mmNuber : " + mmConvert);		// 시간(분)
    	     System.out.println("value : " + value); */			// 시간(초로 환산)
      		%>
      		...
      		var dd = <%=dd[0]%>;
      		var value = <%=value%>
      		dataRow = [new Date(yy, mm-1, dd , '10'), value];
      		data.addRow(dataRow);
