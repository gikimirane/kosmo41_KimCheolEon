...
public interface IDao {
	...
	public ArrayList<JoinDto> JoinDao0(int nStart, int nEnd, String search);
	...
	public void jmake_join(String Name, String Email);
	...
	public ArrayList<content_ReplyDto> content_reply_view(String numId);
	public content_ReplyDto idcheck(String numId);
	...
	public ArrayList<Joinapply> groupUser(int numId);
