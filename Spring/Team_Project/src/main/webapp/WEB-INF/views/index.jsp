...
<html>
<head>
<title>My Pets a Animal Category Flat Bootstarp responsive Website Template | Home :: w3layouts</title>
...
<body>
	...
	<div class="header">
		<div class="header-top">
			<div class="container">
				<p class="location"><i class="location"></i>한국소프트웨어인재개발원</p>
				<p class="phonenum">이건후  김철언  한동인</p>
		...
		<div class="header-bottom">
			<div class="container">
				<div class="logo">
					<a href="index"><img src="resources/web/images/logo.png" alt="" /></a>
				</div>
				<span class="menu"></span>
				<div class="top-menu">
					<ul>
					<nav class="cl-effect-5">
						<li><a class="active" href="index"><span data-hover="Home">Home</span></a></li> 
						<li><a href="about.html"><span data-hover="About">About</span></a></li>
						<li><a href="photos.html"><span data-hover="Photos">Photos</span></a></li> 
						<li><a href="404.html"><span data-hover="Care">Care</span></a></li> 
	...
	<div class="slider" width="100px" height="100px">	  
		  <div class="callbacks_container">
			  <ul class="rslides" id="slider">
				 <li>
					 <img src="resources/web/images/3.jpg" alt=""/>
					  <div class="caption">
				 ...
				 <li>
					 <img src="resources/web/images/2.jpg" alt=""/>
					  <div class="caption">
				 ...
				 <li>
					 <img src="resources/web/images/1.jpg" alt=""/>
					  <div class="caption">
			...
			<div class="welcome-section">
				<div class="container">
					...
					<div class="col-md-6 images">
						<div class="img1">
							<img src="resources/web/images/a1.jpg" class="img-responsive" alt="" />
						</div>
						<div class="img2">
						<img src="resources/web/images/a2.jpg" class="img-responsive" alt="" />
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="clearfix"></div>
	...
	<div class="main-map">
		    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3166.230275006728!2d126.87673151571332!3d37.47889197981442!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357b61e3354204f9%3A0x12b02f6401815f80!2z7ZWc6rWt7IaM7ZSE7Yq47Juo7Ja07J247J6s6rCc67Cc7JuQ!5e0!3m2!1sko!2skr!4v1542247790804" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
		</div>
