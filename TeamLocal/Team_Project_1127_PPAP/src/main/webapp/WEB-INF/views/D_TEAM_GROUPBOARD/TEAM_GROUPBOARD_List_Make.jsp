...
<%
		...
		curTime = (String)session.getAttribute("curTime");
		userEmail = (String)session.getAttribute("email_id");
	}
%>
<
...
<body class="onoffmix">
	...
	<header id="header">
		...
		<div class="content_wrapping max_width_area">
			...
			<section class="main_area">
				...
				<form  action="jmake" method="post" enctype="multipart/form-data" name="jamke_check">
				...
				<div class="event_input_area">
					<div class="edit_wrap">
						...
						<fieldset class="edit_summary">
							...
							<div class="edit">
								<div class="write_wrap">
									<input type="number" min="0" max="100" onkeypress="return event.charCode >= 48" placeholder="정원설정 해주세요." name="fixed"
										required data-parsley-class-handler=".edit_summary"
						...
						<div class="bottom_btn_area">
							<div class="btn_wrap">
								<input type="button" value="개설완료" onclick="datecheck();" class="btn_submit">
							</div>
						</div>
					</div>
				</div>
	...
	<script type="text/javascript">
		function datecheck() {
			...
			if (document.jamke_check.title.value == "") {
				alert("모임명을 입력하세요.")
				document.jamke_check.title.focus();
				return;
			}
			if (document.jamke_check.JoinStart_date.value == "" || document.jamke_check.JoinEnd_date.value == "") {
				alert("모임일시를 입력하세요.")
				document.jamke_check.JoinStart_date.focus();
				return;
			}
			if (document.jamke_check.Start_date.value == "" || document.jamke_check.End_date.value == "") {
				alert("접수기간을 입력하세요.")
				document.jamke_check.Start_date.focus();
				return;
			}
			if (document.jamke_check.address.value == "" ) {
				alert("모임장소를 입력하세요.")
				document.jamke_check.address.focus();
				return;
			}
			if (document.jamke_check.content.value == "" ) {
				alert("모임소개를 입력하세요.")
				document.jamke_check.content.focus();
				return;
			}
			if (document.jamke_check.fixed.value == "" ) {
				alert("정원을 설정하세요.")
				document.jamke_check.fixed.focus();
				return;
			}
			if (document.jamke_check.upload.value == "" ) {
				alert("모임에 어울리는 사진을 올려주세요.")
				document.jamke_check.upload.focus();
				return;
			}

			document.jamke_check.submit();
		}
	</script>
	<!-- =================================== 화면 고유 시작 ===================================  -->
	<!-- Plugin -->
