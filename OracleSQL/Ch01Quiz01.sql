-- Chapter 02_ 데이터 조회하기 -- 책이 오름차순과 내림차순을 혼동한다;;
select * from employee;

--01.덧셈 연산자를 이용하여 모든 사원에 대해서 $300 의 급여 인상을 계산한 후 
...
--실험해봤는데, as 로 이름을 준다음에 그걸 대상으로 order 가능
...
--07.부서 번호가 20 및 30에 속한 사원의 이름과 부서번호를 출력하되 
...
--select ename, job, salary from employee where (job='CLERK' or job='SALESMAN') and salary not in(1600, 950, 1300); --in 이 좋지 않다고 하여 수정해봄
